...
class Rules extends Admin {
	...
	/**
	 * this method will load the rules section in the admin dashboard
	 */
	public function index(){
		...
		if(isset($user_logged['user_name'])){
			$results = $this->sections->getSectionStatus('rules');
			...
			if($this->input->is_ajax_request()){
				...
				$load_section = $this->load->view('pages/admin/admin-content-templates/content-rules', $data, true);
				...
				$this->load->view('pages/admin/admin-content-templates/content-rules', $data);
