...
class Social_Media extends Admin {
	...
	/**
	 * This method will load the social media section in the admin dashboard
	 */
	public function index(){
		...
		if(isset($user_logged['user_name'])){
			...
			$results = $this->sections->getSectionStatus('social_media');
			...
			if($this->input->is_ajax_request()){
				...
				$this->load->view('pages/admin/admin-content-templates/content-social-media', $data);
