...
class Front_Sections extends Admin {
	...
	/**
	 * this method will load the front sections section in the admin dashboard
	 */
	public function index() {
		...
		if(isset($user_logged['user_name'])){
			$results = $this->sections->getSectionStatus('front_sections');
			...
			if($this->input->is_ajax_request()){
				...
				$load_section = $this->load->view('pages/admin/admin-content-templates/content-front-sections', $data, true);
				...
				$this->load->view('pages/admin/admin-content-templates/content-front-sections', $data);
